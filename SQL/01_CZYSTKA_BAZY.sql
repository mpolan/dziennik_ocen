...
/
BEGIN EXECUTE IMMEDIATE 'DROP PROCEDURE AKTUALIZUJ_OCENE'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP PROCEDURE USUN_OCENE'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
